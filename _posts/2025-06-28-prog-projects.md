...
> **mcp-filestore** is an MCP server, deployable as a free cloudflare worker, which can endow any agent(s) with Claude Code-style interaction with a persistent filesystem - securely, seamlessly, in the cloud, and for free.

On [GitHub](https://github.com/XaviACLM/mcp-filestore). Complete.
